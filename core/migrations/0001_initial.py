    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(verbose_name='Дата начала')),
                ('end_date', models.DateField(verbose_name='Дата окончания')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quarters', to='core.academicyear', verbose_name='Учебный год')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quarter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='gat_tests', to='core.quarter', verbose_name='Четверть')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='gat_tests', to='core.school', verbose_name='Школа')),
            ],
            options={
                'verbose_name': 'GAT Тест',
                'verbose_name_plural': 'GAT Тесты',
                'ordering': ['-test_date', 'test_number'],
            },
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('name', models.CharField(max_length=100, verbose_name='Название')),
                ('abbreviation', models.CharField(blank=True, max_length=50, verbose_name='Сокращение (для Excel)')),
                ('gat_info', models.CharField(blank=True, choices=[('GAT-1', 'GAT-1'), ('GAT-2', 'GAT-2'), ('GAT-3', 'GAT-3'), ('GAT-4', 'GAT-4')], max_length=10, verbose_name='Тип GAT')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='core.school', verbose_name='Школа')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='question',
            name='subject',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='questions', to='core.subject', verbose_name='Предмет'),
        ),
        migrations.AddField(
            model_name='gattest',
            name='subjects',
            field=models.ManyToManyField(related_name='gat_tests', to='core.subject', verbose_name='Предметы в тесте'),
        ),
        migrations.CreateModel(
            name='TeacherNote',
            fields=[
