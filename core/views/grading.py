# D:\New_GAT\core\views\grading.py (ФИНАЛЬНАЯ ВЕРСИЯ С ПРАВАМИ ДОСТУПА)
...
def _get_grading_context(get_params, request_user):
    """
    Готовит полные данные для страницы Оценок с фильтрацией по правам доступа.
    """
